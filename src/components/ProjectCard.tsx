		...
		<Suspense fallback={<SkeletonProjectCard/>} >
			<figure className="waiter w-fit min-h-[15rem] p-4 bg-[rgba(13_13_13_/.6)] rounded-md flex flex-col md:flex-row space-y-3 md:space-x-2">
				...
				<div className="relative space-y-[10px]">
					...
					<a className="w-full md:w-fit px-4 py-2 flex justify-center bg-indigo-500 hover:bg-indigo-600 cursor-pointer font-bold rounded-md active:scale-[.9] shadow-[3px_3px_0_0_#000] active:shadow-[none] transition-all ease-in-out md:absolute md:bottom-2 md:right-2" 
						href={git} 
...
function SkeletonProjectCard(){
    return(
        <figure className="w-fit h-[15rem] p-4 bg-[rgba(13_13_13_/.6)] rounded-md flex space-x-2 animate-pulse">
			...
			<img
				className="h-full w-[40%] object-contain bg-[#333]" 
			></img>
			...
			<div className="relative space-y-[10px]">
				...
				<a className=" w-4 h-2 px-4 py-2 rounded-md  absolute bottom-2 right-2 bg-[#333]" 
				></a>
			</div>
